...
function list(query = {}) {
  ...
  return { total, offset, limit, items: items.slice(offset, offset + limit).map(summarize) };
}
...
module.exports = { addFromResult, update, remove, list, get, stats, toCsv, recentSame, findRelated, STATUSES, FILE };
